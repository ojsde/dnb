...
mittels DNB-Hotfolder-Verfahren. Das Plugin bietet auch die Option, das Transferpaket direkt in den DNB-Hotfolder abzuliefern.
...
Das Plugin ist unter GNU General Public License v3 lizenziert. Sehen Sie die Datei LICENSE für mehr Informationen über die Lizenz.
...
Bitte immer die neuste Revisionsnummer (.x) des Plugins für die installierte OJS Version benutzen:
  | OJS version | Pluginversion    | Support Status |
  | ----------- | ----------------- | -------------- |
...
Die Plugin-Einstellungen finden Sie unter "Werkzeuge > DNB-Export-Plugin > Einstellungen". Eine detaillierte Beschreibung der Einstellungen steht in der [Dokumentation](docs/manual/de/settings.md) zur Verfügung.
...
Die Plugin-Export-Schnittstelle ist hier zu finden:
Werkzeuge > DNB-Export-Plugin > Artikel

## Hinweis

Wenn Sie Artikel direkt aus OJS heraus abliefern möchten, müssen Sie Ihren Benutzernamen, Ihr Passwort und Ihre Unterordner-ID in die Plugin-Einstellungen eintragen.
...
Dokumentation, Fehlerauflistung und Updates können auf dieser Plugins-Startseite gefunden werden <http://github.com/ojsde/dnb>.
